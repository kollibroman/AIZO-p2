...
inline bool findShortestPathBellmanFord(GigaKomarVector<Node>& graph, int startNodeIndex) {
...
inline GigaKomarVector<Node*> getPath(Node* destination) {
